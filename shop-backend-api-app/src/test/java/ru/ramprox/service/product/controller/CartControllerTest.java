...
//import ru.ramprox.service1.product.controller.dto.AddLineItemDto;
//import ru.ramprox.service1.product.controller.dto.AllCartDto;
...
//import ru.ramprox.repository.service.CartServiceImpl;
...
//import static ru.ramprox.Util.assertEqualsLineItems;
//
////@ActiveProfiles("test")
...
////        Brand brand = brandRepository.save(new Brand("Brand1"));
...
////        product.setPrice(new BigDecimal(5678));
////        category.addProduct(product);
////        brand.addProduct(product);
////        productRepository.save(product);
//    }
